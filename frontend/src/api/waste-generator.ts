...
export async function updateWasteGenerator(id: number, input: Partial<DomainRecord>) {
  return request<DomainRecord>(`/generators/${id}`, { method: 'PUT', body: JSON.stringify(input) });
}
