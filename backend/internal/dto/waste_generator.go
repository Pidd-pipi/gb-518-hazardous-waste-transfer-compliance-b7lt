...
type CreateWasteGenerator struct {
	...
	// Destinations is the optional list of filed disposal plants. Empty or
	// omitted means the generator currently has no valid 备案去向.
	Destinations []DisposalDestinationInput `json:"destinations"`
}
